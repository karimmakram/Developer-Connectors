...
profileRoute.put('/experience', Auth, [check('company', 'company is required').not().isEmpty(),
check('title', 'title is required').not().isEmpty(),
check('location', 'location is required').not().isEmpty(),
check('from', 'from is required').not().isEmpty()],
    profile.addExperience)

profileRoute.delete('/experience/:id', Auth, profile.deleteExperience)

/// education
profileRoute.put('/education', Auth, [check('school', 'school is required').not().isEmpty(),
check('degree', 'degree is required').not().isEmpty(),
check('filedofstudy', 'filedofstudy is required').not().isEmpty(),
check('from', 'from is required').not().isEmpty()],
    profile.addEducation)

profileRoute.delete('/education/:id', Auth, profile.deleteEducation)
